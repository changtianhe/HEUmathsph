...
c     3-dim. problem: maxngx = maxngy = maxngz ~ maxn^(1/3)
     ...
     &        pair_j(max_interaction), countiac(maxn)
      double precision hsml, x(maxdim,maxn),w(max_interaction),
     &       dwdx(maxdim,max_interaction)
     ...
     &     dnxgcell(maxdim),dpxgcell(maxdim),ngridx(maxdim),
     &     ghsmlx(maxdim)
      double precision hsml2,dr,r,dx(maxdim),mingridx(maxdim),
     &                   maxgridx(maxdim),
     &       tdwdx(maxdim), dgeomx(maxdim)
